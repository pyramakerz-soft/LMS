                    ...
                    <div class="block md:flex flex-wrap gap-4 my-5 ">
                        <div class="flex space-x-3 p-5 border rounded-lg w-fit min-w-80">
                            ...
                            <div>
                                ...
                                <p class="text-[#989692] text-sm my-1">{{ is_numeric($assignment->file_size) ? number_format($assignment->file_size / 1024, 2). ' KB' : $assignment->file_size }}</p>
                                <a download="Assignment_{{$assignment->id}}" href="{{ asset($assignment->path_file) }}" target="_blank" class="font-semibold text-[#A020F0]">Click to download</a>
                            </div>
                        </div>
                    </div>
                @endif
