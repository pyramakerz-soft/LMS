...
@section("login")
    <div class="lg:h-[100vh] flex flex-col-reverse lg:flex-row">
        <div class="w-full lg:w-1/3 bg-white flex flex-col justify-center items-center p-12 md:p-20">
            ...
            <button class="mt-4 w-full text-white font-semibold text-xs shadow-sm bg-[#17253E] border border-[#17253E] py-2 rounded-md">Sign in</button>
        </div>
