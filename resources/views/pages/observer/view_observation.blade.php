...
<div class="p-3 text-[#667085] my-8">
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold">View Observation</h1>
    </div>
    <div class="overflow-x-auto">
        <div class="mb-4 flex" style="gap:10px; padding:10px">
            ...
            <div class="questions mb-3" style="max-width: 650%;">
                ...
                @php
                $header = App\Models\ObservationHeader::find(App\Models\ObservationQuestion::find($answers->first()->question_id)->observation_header_id)
                @endphp
