...
@section("content")
    <form action="" method="POST">
        <div class="flex justify-between mb-5 items-center">
            <div>
                <p class="text-[#272D37] font-semibold text-2xl md:text-3xl">Unit</p>
            </div>
            <button type="submit"
        ...
        <div class="border border-[#ECECEC] rounded-lg p-4 md:p-8 shadow-md shadow-[#0000001F]">
            ...
            <label htmlFor="material" class="block mb-3 font-semibold text-xs md:text-sm text-[#3A3A3C] mt-5">
                Material
            </label>
            <select id="material" name="material" class="w-full p-2 md:p-4 border border-[#E5E5EA] rounded-xl">
                <option value="" disabled selected hidden>Choose</option>
