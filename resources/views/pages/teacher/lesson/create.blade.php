    ...
    <form action="" method="POST">
        ...
        <div class="border border-[#ECECEC] rounded-lg p-4 md:p-8 shadow-md shadow-[#0000001F]">
            ...
            <input id="title" name="title" type="text"
                class="border border-[#E5E5EA] rounded-lg w-full p-2 md:p-4 text-xs md:text-base" placeholder="Enter Title">
            ...
            <label htmlFor="chapter" class="block mb-3 font-semibold text-xs md:text-sm text-[#3A3A3C] mt-5">
                Chapter
            </label>
            <select id="chapter" name="chapter" class="w-full p-2 md:p-4 border border-[#E5E5EA] rounded-xl">
                <option value="" disabled selected hidden>Choose</option>
            ...
            <div class="flex items-center space-x-4">
                <div class="flex justify-center md:justify-start w-full md:w-1/3">
                    <label for="image"
                        class="cursor-pointer flex flex-col items-center bg-[#F6F6F6] rounded-xl px-6 py-3 lg:py-5">
                        <img src="{{ asset('images/AddPhoto.png') }}" class="w-1/4">
                        <span
                            class="bg-[#FF7519] text-white px-4 md:px-8 py-2 lg:py-4 lg:font-semibold text-xs md:text-sm rounded-lg my-2 md:my-4 text-center">Select
                            Image</span>
